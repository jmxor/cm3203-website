...
function GMCSection(props: GCMSectionProps) {
  ...
  return (
    <div className="relative w-full shrink-0 bg-[url('../../public/gcm-bg-0.svg')]">

      <div className="absolute top-[49px] left-[9px]">
      ...
      <div className="w-[194px] flex flex-col items-center justify-center ml-auto mr-12">
        ...
        <div className="w-[98px] h-[50px] mt-[72px] mb-6 flex items-center justify-center border-2 border-black rounded font-mono">
          <p className="text-center">Mult<sub>H</sub></p>
        </div>
